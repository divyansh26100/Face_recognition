...
divyansh_image = face_recognition.load_image_file("Divyansh/divyansh.jpeg")
...
akshay_image = face_recognition.load_image_file("Akshay/akshay.jpg")
akshay_face_encoding = face_recognition.face_encodings(akshay_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    divyansh_face_encoding,
